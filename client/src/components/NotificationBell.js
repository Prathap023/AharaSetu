...
function NotificationBell() {
  ...
  const fetchUnreadCount = async () => {
    try {
      const res = await axios.get('https://aharasetu-backend.onrender.com/api/notifications/unread-count', {
  ...
  const fetchNotifications = async () => {
    try {
      const res = await axios.get('https://aharasetu-backend.onrender.com/api/notifications', {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const handleMarkAllRead = async () => {
    try {
      await axios.put('https://aharasetu-backend.onrender.com/api/notifications/mark-all-read', {}, {
        headers: { Authorization: `Bearer ${token}` }
      });
      setUnreadCount(0);
      fetchNotifications();
  ...
  const handleMarkOneRead = async (id) => {
    try {
      await axios.put(`https://aharasetu-backend.onrender.com/api/notifications/mark-read/${id}`, {}, {
        headers: { Authorization: `Bearer ${token}` }
      });
      fetchUnreadCount();
      fetchNotifications();
  ...
  const handleDeleteAll = async () => {
    try {
      await axios.delete('https://aharasetu-backend.onrender.com/api/notifications/delete-all', {
        headers: { Authorization: `Bearer ${token}` }
      });
      setNotifications([]);
      setUnreadCount(0);
